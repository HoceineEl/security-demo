        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-3xl font-bold text-indigo-600 dark:text-indigo-400">{{ $stats['totalUsers'] }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Total Posts</h3>
                    <p class="text-3xl font-bold text-green-600 dark:text-green-400">{{ $stats['totalPosts'] }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Active Users</h3>
                    <p class="text-3xl font-bold text-blue-600 dark:text-blue-400">{{ $stats['activeUsers'] }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">New Users (24h)</h3>
                    <p class="text-3xl font-bold text-purple-600 dark:text-purple-400">{{ $stats['newUsers'] }}</p>
                </div>
            </div>
